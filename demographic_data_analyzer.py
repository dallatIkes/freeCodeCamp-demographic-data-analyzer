...
def calculate_demographic_data(print_data=True):
    ...
    for country in countries:
        ...
        country_rich_percentage = round(rich_count / total_count * 100, 1)
        rich_percentages[country] = country_rich_percentage

    highest_earning_country = rich_percentages[rich_percentages == rich_percentages.max()].index[0]
